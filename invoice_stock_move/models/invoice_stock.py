...
class InvoiceStockMove(models.Model):
    ...
    def _get_stock_type_ids(self):
        ...
        if self._context.get('default_move_type') == 'out_invoice' or self._context.get('default_move_type') == 'out_refund':
            for line in data:
                if line.code == 'outgoing':
                    return line
        if self._context.get('default_move_type') == 'in_invoice' or self._context.get('default_move_type') == 'in_refund':
            for line in data:
